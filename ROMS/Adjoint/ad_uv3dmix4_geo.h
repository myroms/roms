...
#endif
      CALL ad_uv3dmix4_tile (ng, Istr, Iend, Jstr, Jend,                &
     &                       LBi, UBi, LBj, UBj,                        &
     &                       nrhs(ng), nnew(ng),                        &
#ifdef MASKING
     &                       GRID(ng) % pmask,                          &
...
!
!***********************************************************************
      SUBROUTINE ad_uv3dmix4_tile (ng, Istr, Iend, Jstr, Jend,          &
     &                             LBi, UBi, LBj, UBj,                  &
     &                             nrhs, nnew,                          &
#ifdef MASKING
...
!
      ...
      real(r8), dimension(PRIVATE_2D_SCRATCH_ARRAY,N(ng)) :: ad_LapU
      real(r8), dimension(PRIVATE_2D_SCRATCH_ARRAY,N(ng)) :: ad_LapV
...
!
      ...
      ad_LapU(ILB:IUB,JLB:JUB,1:N(ng))=0.0_r8
      ad_LapV(ILB:IUB,JLB:JUB,1:N(ng))=0.0_r8
!
!-----------------------------------------------------------------------
