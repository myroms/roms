...
#endif
      CALL ad_t3dmix4_tile (ng, Istr, Iend, Jstr, Jend,                 &
     &                      LBi, UBi, LBj, UBj,                         &
     &                      nrhs(ng), nnew(ng),                         &
#ifdef MASKING
     &                      GRID(ng) % umask,                           &
...
!
!***********************************************************************
      SUBROUTINE ad_t3dmix4_tile (ng, Istr, Iend, Jstr, Jend,           &
     &                            LBi, UBi, LBj, UBj,                   &
     &                            nrhs, nnew,                           &
#ifdef MASKING
     &                            umask, vmask,                         &
...
!
      ...
      real(r8), dimension(PRIVATE_2D_SCRATCH_ARRAY) :: ad_LapT
...
!
      ...
      ad_LapT(ILB:IUB,JLB:JUB)=0.0_r8
!
!----------------------------------------------------------------------
