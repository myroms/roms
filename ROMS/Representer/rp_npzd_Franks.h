...
#  ifdef TL_IOMS
     ...
     &              +(0.5_r8-SIGN(0.5_r8,Bio_bak(i,k,iPhyt)-eps))       &
     &              +(0.5_r8-SIGN(0.5_r8,Bio_bak(i,k,iZoop)-eps))       &
     &              +(0.5_r8-SIGN(0.5_r8,Bio_bak(i,k,iSDet)-eps)))*eps
#  endif
!
...
!
     ...
     &                                   -REAL(itrmx-ibio,r8)**2))+     &
#  ifdef TL_IOMS
     &              eps*(0.5_r8+SIGN(0.5_r8,eps-Bio_bak(i,k,ibio)))
#  endif
              END DO
            ELSE
              DO itrc=1,NBT
...
#  ifdef TL_IOMS
     ...
     &               Bio1(i,k,iNO3_)*cff/(K_NO3(ng)+Bio1(i,k,iNO3_))
#  endif
...
#  ifdef TL_IOMS
     &                          cff*Bio(i,k,iPhyt)/(1.0_r8+cff+cff2)
#  endif
!             Bio(i,k,iZoop)=Bio(i,k,iZoop)+                            &
!    &                       Bio(i,k,iPhyt)*cff*(1.0_r8-ZooGA(ng))
...
!  NOTE: We MUST multiply basic state t by Hz here.
!-----------------------------------------------------------------------
!
        DO itrc=1,NBT
          ibio=idbio(itrc)
          DO k=1,N(ng)
            DO i=Istr,Iend
!> The following NL code has been modfied with Hz factor.
