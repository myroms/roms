...
#endif
      CALL rp_prsgrd_tile (ng, Istr, Iend, Jstr, Jend,                  &
     &                     LBi, UBi, LBj, UBj,                          &
     &                     nrhs(ng),                                    &
     &                     GRID(ng) % om_v,                             &
     &                     GRID(ng) % on_u,                             &
...
!
!***********************************************************************
      SUBROUTINE rp_prsgrd_tile (ng, Istr, Iend, Jstr, Jend,            &
     &                           LBi, UBi, LBj, UBj,                    &
     &                           nrhs,                                  &
     &                           om_v, on_u,                            &
     &                           Hz, tl_Hz,                             &
...
!
      ...
      real(r8), dimension(PRIVATE_1D_SCRATCH_ARRAY) :: tl_phie
      real(r8), dimension(PRIVATE_1D_SCRATCH_ARRAY) :: tl_phix
