...
!BOP -------------------------------------------------------------------
!
! !ROUTINE:  Provide a simple example of using MCT to connect two components
!
! !DESCRIPTION:
!
! !INTERFACE:
...
!--- Get only the things needed from MCT
      ...
      integer :: comm1,comm2,asize,mysize,i,ngx,ngy,myproc
...
! arguments.  Both components and main share the same processors.
